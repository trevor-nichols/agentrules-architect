...
- 2026-03-08: Use one app-server process per architect instance (and short-lived processes for settings actions) rather than a shared multiplexed daemon. Rationale: simpler lifecycle, simpler tests, no concurrent notification routing, and adequate performance for the initial production implementation.
